...
\frame{\maketitle
\begin{center}
\includegraphics[width=75mm]{figures/bandeau_conf.eps}
\end{center}
}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/fig1.eps}
\end{center}
}

\frame{\frametitle{Marina del Carmoli wetland (300 ha)}
\begin{center}
\includegraphics[width=\textwidth]{figures/cr10.eps}
\end{center}
}
...
\end{block}
\begin{center}
\includegraphics[width=\textwidth]{figures/mc_ila_pcoms.eps}
\end{center}
\begin{exampleblock}{}
\begin{itemize}
...
\begin{center}
\includegraphics[width=\textwidth]{figures/cr10_ws_lulc.eps}
\end{center}
}
...
\end{alertblock}
\begin{center}
\includegraphics[width=0.7\textwidth]{figures/vegmaps_mc.eps}
\\
...
\end{block}
\begin{center}
\includegraphics[width=0.25\textwidth]{figures/Rlogo.eps}
\end{center}
}
...
\end{exampleblock}
\begin{center}
\includegraphics[width=0.5\textwidth]{figures/pixel.eps}
\end{center}
}
...
%\end{exampleblock}
%\centering
%\includegraphics[width=\textwidth]{figures/mcdynmod1.eps}
%\begin{alertblock}{}
...
\end{exampleblock}
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/mc_ila_pcoms.eps}\\
\includegraphics[width=0.7\textwidth]{figures/growth.eps}
\end{center}
}
...
\end{exampleblock}
\begin{center}
\includegraphics[width=0.3\textwidth]{figures/expansion2.eps} \hspace{5mm}
\includegraphics[width=0.5\textwidth]{figures/neighborhood3.eps}
\end{center}
}
...
\end{exampleblock}
\begin{center}
\includegraphics[width=0.6\textwidth]{figures/mc_ila_warp_time.eps}
\end{center}
}
...
\end{itemize}
\end{exampleblock}
\includegraphics[angle=-90,width=\textwidth]{figures/env_spat_var.eps}
\begin{alertblock}{}
\begin{itemize}
...
\begin{center}
\includegraphics[width=\textwidth]{figures/mcdynmod3.eps}
\end{center}
}
...
\end{block}
%\begin{center}
%\includegraphics[width=0.5\textwidth]{figures/neighborhood2.eps}
%\end{center}
}
...
%\begin{center}
\includegraphics[angle=-90,width=0.34\textwidth]{figures/rstack_compar.eps}
%\end{center}
}

%\frame{\frametitle{Simulated total area of each plant community}
%\centering
%\includegraphics[width=0.6\textwidth]{figures/val_all_areas.eps}
%\begin{alertblock}{}
...
\end{itemize}
\item Needs further developments
\item Source code will be documented and available on GitHub
\end{enumerate}
\end{block}
}
